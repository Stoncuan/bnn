                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Total Data Register URIN</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalUrin ?></div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Total Data Register P4GN</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalP4gn ?></div>
                                </div>
                                <div class="col-auto">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; BNN 2026</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
